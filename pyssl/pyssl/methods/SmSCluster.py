...
from river.base import Classifier, typing as river_typing
...
class _SmSCluster(BaseSKMObject, ClassifierMixin, MetaEstimatorMixin):
...
class SmSCluster(SemiSupervisedClassifier):
    ...
    def learn_one(self, x: dict, y: SemiSupervisedLabel) -> "SmSCluster":
        ...
        assert self.x_shape == sk_x.shape, "The shape of the input data is not consistent with the previous data."
