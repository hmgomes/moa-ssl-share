/*
 *    MultiTargetTaskManagerPanel.java
 ...
 * @version $Revision: 7 $
 */
public class MultiTargetTaskManagerPanel extends JPanel {
    ...
    protected class TaskTableModel extends AbstractTableModel {
        ...
        public int getRowCount() {
            return MultiTargetTaskManagerPanel.this.taskList.size();
        }
    ...
    private static void createAndShowGUI() {
        ...
        JPanel panel = new MultiTargetTaskManagerPanel();
